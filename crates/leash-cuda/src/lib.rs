...
pub const ARTIFACT_SHA256: &str =
    "9a09844a57df173929ec20282fdd04cfaf6660635e70fec1b83c15347b53d2ba";
pub const SOURCE_SHA256: &str = "9e66815108672598be6fbff3de70f9139a434fb4df9cd2138cc170116d354c6f";
...
mod tests {
    ...
    fn artifact_metadata_is_specific_and_complete() {
        ...
        assert_eq!(artifact.bytes, 47_200);
