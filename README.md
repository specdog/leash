...
- **Pawprint catalog.** Runnable sim, MCP, HTTP, and compatibility demos. `leash list` + `leash run <pawprint>`.
...
- [ ] Pawprint catalog: `leash list` + `leash run`
