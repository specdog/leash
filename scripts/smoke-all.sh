...
const checks = [
  ...
  },
  {
    ...
    proof: "HTTP MCP tool list, health/stop calls, CLI status/modules, key=value/JSON direct calls, planner set/status calls, and patrol start/status/stop calls passed",
  },
  {
